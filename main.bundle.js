...
function createTaskDeleteDialog(task) {
    ...
    yesButton.addEventListener('click', () => {
        const mainContent = (0,_main_main__WEBPACK_IMPORTED_MODULE_2__.getMainContent)();
